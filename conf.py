...
BLOG_AUTHOR = "Aswin Manohar"  # (translatable)
BLOG_TITLE = "Aswin Manohar"  # (translatable)
...
BLOG_EMAIL = "aswinbio@gmail.com"
BLOG_DESCRIPTION = "this is my personal site"  # (translatable)
